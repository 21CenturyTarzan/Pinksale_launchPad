...
const RinkebyUrl = `https://eth-rinkeby.alchemyapi.io/v2/${process.env.ALCHEMY_API_KEY}`;
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    "bsc-testnet": {
      url: "https://speedy-nodes-nyc.moralis.io/20cea78632b2835b730fdcf4/bsc/testnet",
      accounts: [`${process.env.PRIVATE_KEY}`],
      chainId: 97,
      live: true,
      saveDeployments: true,
